    ...
    <div className="page">
      ...
      <div className="glass-card">
        <div className="search-input" style={{ marginBottom: 16 }}>
          ...
          <input type="text" placeholder="Search by product name, SKU, or barcode..." value={search} onChange={(e) => { setSearch(e.target.value); setPage(1) }} />
        </div>
                ...
                <tr key={item.inventory_id}>
                  <td>
                    {item.primary_image_url ? (
                      <img src={resolveImageUrl(item.primary_image_url)} alt="" style={{ width: 40, height: 40, objectFit: 'cover', borderRadius: 'var(--radius-button)', border: '1px solid var(--border)' }} />
                    ) : (
