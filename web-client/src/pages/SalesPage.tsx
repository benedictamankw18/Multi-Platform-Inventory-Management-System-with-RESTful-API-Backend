        ...
        <div className={`receipt receipt-${paperSize === '58mm' ? '58' : '80'}`}>
          ...
          <div className="receipt-section receipt-totals">
            ...
            {Number(receiptData?.sale?.discount_amount ?? 0) > 0 && (
              <div className="receipt-row r-discount"><span>Discount</span><span>-{(businessInfo.currency || 'GHS') + ' ' + Number(receiptData.sale!.discount_amount).toFixed(2)}</span></div>
            )}
            {Number(receiptData?.sale?.tax_amount ?? 0) > 0 && (
              <div className="receipt-row"><span>Tax</span><span>{(businessInfo.currency || 'GHS') + ' ' + Number(receiptData.sale!.tax_amount).toFixed(2)}</span></div>
            )}
          ...
          <div className="receipt-section receipt-payment">
            ...
            {Number(receiptData?.sale?.balance_due ?? 0) > 0 && (
              <div className="receipt-row r-remain"><span>Balance Due</span><span>{(businessInfo.currency || 'GHS') + ' ' + Number(receiptData.sale!.balance_due).toFixed(2)}</span></div>
            )}
          </div>
