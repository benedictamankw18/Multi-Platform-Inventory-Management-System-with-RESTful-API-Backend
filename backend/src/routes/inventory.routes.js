...
router.post('/', authenticate, checkPermission('MANAGE_INVENTORY'), createInventoryValidation, validate, idempotency('inventories'), inventoryController.createInventory);
